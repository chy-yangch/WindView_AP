...
rfStatus_t cc120xSpiReadReg(SPI_T *spi, uint16_t addr, uint8_t *data, uint8_t len);
rfStatus_t cc120xGetTxStatus(SPI_T *spi);
rfStatus_t cc120xGetRxStatus(SPI_T *spi);  
rfStatus_t cc120xSpiWriteReg(SPI_T *spi, uint16_t addr, uint8_t *data, uint8_t len);
rfStatus_t cc120xSpiWriteTxFifo(SPI_T *spi, uint8_t *pWriteData, uint8_t len);
rfStatus_t cc120xSpiReadRxFifo(SPI_T *spi, uint8_t *pReadData, uint8_t len);
int8_t perCC120xRead8BitRssi(SPI_T *spi);
void cc1200_channel_config(SPI_T *spi, uint8_t);
